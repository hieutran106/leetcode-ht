...
class Solution:
    def maxResult(self, nums: List[int], k: int) -> int:
        """
        We don't need the whole dp array, thus use res as dp[i]
        """
        res = nums[0]
        dq = deque()
        dq.append((nums[0], 0))
        for i in range(1, len(nums)):
            res = nums[i] + dq[0][0]
            # handle decreasing queue
            while dq and dq[-1][0] <= res:
                dq.pop()
            dq.append((res, i))
    ...
    def maxResult_dp_array(self, nums: List[int], k: int) -> int:
        dp = [0] * len(nums)
        dp[0] = nums[0]
        dq = deque()
        dq.append((nums[0], 0))
    ...
    def maxResult_TLE(self, nums: List[int], k: int) -> int:
        dp = [0] * len(nums)
        dp[0] = nums[0]
        n = len(nums)
        for i in range(1, n):
...
class MyTestCase(unittest.TestCase):
    ...
    def test_case_1(self):
        actual = self.s.maxResult(nums=[1, -1, -2, 4, -7, 3], k=2)
        self.assertEqual(7, actual)

    def test_case_2(self):
        actual = self.s.maxResult(nums=[10, -5, -2, 4, 0, 3], k=3)
        self.assertEqual(17, actual)

    def test_case_3(self):
        actual = self.s.maxResult(nums=[1, -5, -20, 4, -1, 3, -6, -3], k=2)
        self.assertEqual(0, actual)

    def test_case_4(self):
        actual = self.s.maxResult(nums=[10], k=1)
        self.assertEqual(10, actual)

    def test_case_5(self):
        actual = self.s.maxResult(nums=[10], k=5)
        self.assertEqual(10, actual)

    def test_case_6(self):
        actual = self.s.maxResult(nums=[10, -2], k=5)
        self.assertEqual(8, actual)

    def test_case_7(self):
        nums = [-5582, -5317, 6711, -639, 1001, 1845, 1728, -4575, -6066, -7770, 128, -3254, 7281, 3966, 6857, 5477,
        ...
        actual = self.s.maxResult(nums=nums, k=56)
        self.assertEqual(2354241, actual)
